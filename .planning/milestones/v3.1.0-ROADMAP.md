...
- [x] 23-02-PLAN.md — exhaustive 9×5 special-char position matrix (D-02) + explicit canonical OneDrive value re-assertion (L-03) + documented Foo&& boundary guard
...
| 23. Decoder Trailing-Edge Fix | v3.1.0 | 2/2 | Complete    | 2026-06-30 |
